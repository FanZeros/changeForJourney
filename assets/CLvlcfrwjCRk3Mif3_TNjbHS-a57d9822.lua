...
local CARDS = {
    { id = 9,  name = "卡皮巴拉",   orig = "芙罗拉",   title = "自然之使", q = "SSR", qc = {255, 237, 0},
      img = "image/卡皮巴拉_立绘_双参考版_20260912113427.png" },
    { id = 11, name = "熬夜冠军",   orig = "素华",     title = "斩夜姬",   q = "SSR", qc = {255, 237, 0},
      img = "image/熬夜冠军_立绘_双参考版_20260912113554.png" },
    { id = 21, name = "闪电卖鸡",   orig = "亚历克斯", title = "银色闪光", q = "SSR", qc = {255, 237, 0},
