...
local HEROES_BY_QUALITY = {
    [1] = { 1, 2, 3 },                            -- R:   大狗嚼、奶龙龙、叮咚鸡
    [2] = { 4, 5, 6, 7, 8, 9 },                   -- SR:  接化发掌门、叠甲怪、阿姨压一压、信光机兵、愤怒的小雀、卡皮巴拉
    [3] = { 10, 11, 12, 13, 14, 15, 21, 22, 23 },  -- SSR: 铁憨憨~复活吧爱人、闪电卖鸡、小黑子鸡哥、Freestyle诗人
}
