...
function DiaryPage.init(vg)
    imgBg     = nvgCreateImage(vg, "image/界面底板/UI_RZ_BJ.png", 0)
    imgSignIn = nvgCreateImage(vg, "image/界面底板/UI_RZAN_QD.png", 0)
    imgNotice = nvgCreateImage(vg, "image/界面底板/UI_RZAN_GG.png", 0)
    imgBag    = nvgCreateImage(vg, "image/界面底板/UI_RZAN_BB.png", 0)
    imgQuest  = nvgCreateImage(vg, "image/界面底板/UI_RZAN_CJ.png", 0)
    imgMail   = nvgCreateImage(vg, "image/界面底板/UI_RZAN_YJ.png", 0)
