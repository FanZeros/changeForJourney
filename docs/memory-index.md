...
>
> **本会话（2026-09-24）**：把剧情横屏分支、奖励上滚、键盘快捷键、CE 测试面板、遗匣立绘、抠图管线合入，并准备推回 `workspace924`。
>
> **本会话（2026-09-24 `feat/story-landscape-924`）**：开场为来信 → 门厅 → 三人入队。队1写入大狗嚼、黄桃龙、叮咚鸡。侧栏返回用逻辑坐标。索引见 `docs/剧情总表.md`。
>
> **本会话(2026-09-24 feat/ce-test-tools-20260924)**：从 `workspace924` 新开本分支。横屏左上角 `CE` 按钮 / `F1` 打开测试面板：一键测试包、全资源、全英雄、等级/觉醒、跳关、秒杀、无敌、三倍速、跳过引导、副本层、遗匣、天赋、遗物、清档。只 push `feat/ce-test-tools-20260924`，不要推 `workspace924` 或其他分支。
>
