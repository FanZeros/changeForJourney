...
AVC.BRANCHES = {
    ...
    [101] = {
        ...
        talentName = "门闩",
        talentDesc = "门缝的伤害储存上限提高50%。释放伤害时，转向当前敌人的比例提高至50%。",
    ...
    [102] = {
        ...
        talentName = "闸门",
        talentDesc = "门缝填满时强制嘲讽敌人2秒，并清除30%的储存伤害。",
    ...
    [104] = {
        ...
        talentName = "剥壳",
        talentDesc = "击杀精英或首领时获得3层骸骨。消耗骸骨的攻击优先选择护甲克制优势目标。",
    ...
    [105] = {
        ...
        talentName = "错位",
        talentDesc = "裂隙的触发间隔从8秒缩短至6秒。裂痕叠满3层时，额外造成魔法攻击力60%的伤害。",
    ...
    [106] = {
        ...
        talentName = "深缝",
        talentDesc = "裂隙期间，自身攻击轮流附加火焰、冰霜、闪电或暗影伤害类型。",
    ...
    [107] = {
        ...
        talentName = "残响",
        talentDesc = "回响有相当于自身暴击率40%的概率暴击；延迟时间由1.2秒缩短至0.8秒。",
    ...
    [109] = {
        ...
        talentName = "借面",
        talentDesc = "复制目标护甲克制时，若目标会治疗，下次攻击获得8%吸血；否则获得8%攻速，持续4秒。",
    ...
    [110] = {
        ...
        talentName = "剥面",
        talentDesc = "目标死亡时，使附近敌人受到持续2秒的护甲削弱。",
    ...
    [201] = {
        ...
        talentName = "封条",
        talentDesc = "门缝释放的伤害全部转向当前敌人，自己不再承受。",
    ...
    [203] = {
        ...
        talentName = "死闸",
        talentDesc = "嘲讽期间，门缝释放的伤害不再由自己承受。",
    ...
    [205] = {
        ...
        talentName = "骨潮",
        talentDesc = "骸骨不再因额外攻击而消耗，改为每秒减少1层；期间额外攻击伤害提高至40%。",
    ...
    [206] = {
        ...
        talentName = "骨债",
        talentDesc = "骸骨触发额外攻击时消耗自身当前生命的3%，该次额外攻击伤害提高至80%。",
    ...
    [208] = {
        ...
        talentName = "连剥",
        talentDesc = "连续攻击同一目标可积累骸骨获取加成；击杀敌人时，按积累次数额外获得骸骨，切换目标后重新累计。",
    ...
    [209] = {
        ...
        talentName = "群缝",
        talentDesc = "裂隙期间，每次攻击为当前目标叠加0.7层裂痕。",
    ...
    [210] = {
        ...
        talentName = "蚀缝",
        talentDesc = "带有裂痕的敌人每次受伤时，额外受到相当于魔法攻击力50%的暗影伤害（冷却1秒）。",
    ...
    [212] = {
        ...
        talentName = "爆缝",
        talentDesc = "附加伤害类型切换时，对附近敌人造成相当于魔法攻击力100%的伤害。",
    ...
    [213] = {
        ...
        talentName = "风回",
        talentDesc = "每次回响命中都会提高自身攻击速度，最多叠加3层，每层+12%。",
    ...
    [216] = {
        ...
        talentName = "重回",
        talentDesc = "攻击速度超过100%的部分会提高回响伤害：每超过1%，回响伤害提高2%。",
    ...
    [217] = {
        ...
        talentName = "静面",
        talentDesc = "5秒内未受到攻击时，目标的护甲削弱由20%提升至40%。",
    ...
    [219] = {
        ...
        talentName = "致命面",
        talentDesc = "攻击暴击时，立即填满攻击进度（每轮最多触发1次）。",
    ...
    [221] = {
        ...
        talentName = "战祷",
        talentDesc = "延缓触发时，受保护队友的下一次攻击伤害+25%。",
    ...
    [222] = {
        ...
        talentName = "血祷",
        talentDesc = "延缓触发概率改为40%；触发后按原本将受到的伤害回复生命。",
    ...
    [223] = {
        ...
        talentName = "大赦",
        talentDesc = "延缓的治疗量提升至3倍；生命低于20%的队友受到此治疗时必定触发治疗暴击。",
    ...
    [224] = {
        ...
        talentName = "罚忏",
        talentDesc = "治疗时有40%概率对随机敌人造成相当于本次治疗量300%的暗影伤害。",
