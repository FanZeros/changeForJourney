...
AC.DATA = {
    ...
    [18] = {
        "粗暴【草图鉴】：隐踪击杀永久暴击率+0.1%。开战隐踪4秒→5秒",
        "机制：隐踪延长到6秒；隐踪结束下一击必暴。第一击偷克制+0.08",
        "进化：隐踪期间击杀刷新隐踪2秒；第一击偷克制+0.10",
    },
    [19] = {
        "粗暴【功德本金】：清心触发永久精神+0.05。治疗暴击额外+1功德",
        "机制：功德满层从5降到4。清心期间目标每秒回1%最大生命",
        "进化：清心受伤-25%、持续4.5秒；可同时给第二名最低血队友",
    },
    [24] = {
        "粗暴【缓存条】：吐出击杀永久生命上限+1。写入比例25%→35%",
        "机制：容量10%→14%。吐出伤害享受粉碎克制；仇恨系数+20%",
        "进化：闲置4秒即吐出；吐出时对周围再溅射30%",
    },
    [25] = {
        "粗暴【丢包补偿】：延迟结算击杀永久物攻+0.3%。额外延迟伤45%→55%",
        "机制：延迟1.5秒→1.2秒。掉血加成35%→50%；延迟伤可暴击",
        "进化：目标低于30%生命时延迟伤再+25%；场上有封门人时延迟-0.3秒",
    },
}
