...
MailConfig.MAILS = {
    {
        id         = "mail_open_gift",
        title      = "开服礼包",
        body       = "亲爱的远征长，欢迎加入游戏！\n\n为庆祝开服，我们特别为你准备了一份丰厚的开服礼包，助你在远征初期快速成长。\n\n请领取附件中的奖励，开启你的远征之旅吧！\n\n——运营团队 敬上",
        type       = "permanent",
        remainDays = 30,
        rewards    = {
    ...
    },
    {
        id         = "mail_20_pull",
        title      = "惊喜二十连抽",
        body       = "亲爱的远征长，感谢你的支持！\n\n为回馈广大远征者，我们特别赠送20张远征招募券，快去酒馆试试手气吧！\n\n也许命运之神会眷顾你，让你招募到传说中的英雄！\n\n——运营团队 敬上",
        type       = "permanent",
        remainDays = 30,
        rewards    = {
