...
local function withBoot(bagCount, body)
    ...
    ui("ui.battle.BattleScene", { "setOnEnemyKill", "setOnEnemyDrop", "setOnAllDead",
        "setOnStageLoaded", "setOnReincarnate", "setOnFirstClear" })
    inject("ui.battle.BattleScene", {
        getCurrentStageId = function() return 1 end,
        getMaxStageId = function() return h.maxStageId end,
        refreshAllyStats = noop,
    })
    ui("ui.character.CharacterPanel", { "setOnTeamChanged" })
    inject("ui.character.CharacterPanel", { getTotalPower = function() return 0 end })
    ...
    ui("ui.hud.RewardPopup")
    inject("ui.hud.RewardPopup", { show = function(title, rewards, options)
    ...
    ui("ui.hud.PlayerInfoPanel")
    inject("ui.hud.PlayerInfoPanel", { setUID = noop })
