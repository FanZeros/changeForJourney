...
function M.init(nvgCtx)
    vg_ = nvgCtx
    imgBg_   = nvgCreateImage(vg_, "image/界面底板/通用面板/UI_TY_EJQRK.png", 0)
    imgTabA_ = nvgCreateImage(vg_, "image/界面底板/通用面板/UI_TYAN_A.png", 0)
    imgTabB_ = nvgCreateImage(vg_, "image/界面底板/通用面板/UI_TYAN_B.png", 0)
    imgItem_ = nvgCreateImage(vg_, "image/界面底板/弹窗奖励/UI_GG_1.png", 0)
end
