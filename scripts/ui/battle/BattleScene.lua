...
local SweepDialog       = require("ui.battle.SweepDialog")
...
local TerminalConfirmDialog = require("ui.battle.TerminalConfirmDialog")
local MonsterInfoPopup = require("ui.battle.MonsterInfoPopup")
local BattleSpeed = require("ui.battle.BattleSpeed")
local BattleEnemySpawn = require("ui.battle.BattleEnemySpawn")
local BattleTransitionHud = require("ui.battle.BattleTransitionHud")
local BattleStageFlow = require("ui.battle.BattleStageFlow")
local BattleAllyReset = require("ui.battle.BattleAllyReset")
local BattleStageNav = require("ui.battle.BattleStageNav")
local BattleCasualty = require("ui.battle.BattleCasualty")
local BattleStageLoad = require("ui.battle.BattleStageLoad")
local BattleSceneTick = require("ui.battle.BattleSceneTick")
local BattleScenePhases = require("ui.battle.BattleScenePhases")
local BattleStageNavLogic = require("ui.battle.BattleStageNavLogic")
local BattleDataRestore = require("ui.battle.BattleDataRestore")
...
function BattleScene.draw(vg)
    ...
    -- 14.5~14.7 战斗特效
    if require("ui.hud.SettingsPanel").isEffectsEnabled() then
    ...
    -- 15. 浮动伤害数字
    if require("ui.hud.SettingsPanel").isDamageNumbersEnabled() then
