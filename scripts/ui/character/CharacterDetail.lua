...
local DetailAttrs      = require("ui.character.CharacterDetailAttrs")
...
CharacterDetail._ImageCache = require("ui.widget.ImageCache")
CharacterDetail._EquipDetail = require("ui.character.EquipmentDetail")
CharacterDetail._EquipPanel = require("ui.character.CharacterDetailEquip")
...
function CharacterDetail.open(heroId)
    ...
    require("ui.character.HeroScenario").onOpenHero(heroId)
end
...
function CharacterDetail._switchHero(direction)
    ...
    require("ui.character.HeroScenario").onOpenHero(nextHeroId)
end
