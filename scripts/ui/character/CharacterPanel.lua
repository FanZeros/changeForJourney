...
local Draw             = require("ui.character.CharacterPanelDraw2")
local HeroResonance    = require("shared.heroes.HeroResonance")
local CharacterDeploy  = require("ui.character.CharacterDeploy")
local CharacterInput   = require("ui.character.CharacterInput")
local CharacterHeroSync = require("ui.character.CharacterHeroSync")
local CharacterPower    = require("ui.character.CharacterPower")
local CharacterProgress = require("ui.character.CharacterProgress")
...
function CharacterPanel.init(vg)
    ...
    ClientDispatcher.subscribe("heroes", function()
        ...
        refreshPowerCache()
        local ok, BS = pcall(require, "ui.battle.BattleScene")
