...
local function getDungeonBattle()
    if not DungeonBattle_ then DungeonBattle_ = require("ui.dungeon.DungeonBattle") end
...
local function getDungeonBattleScene()
    if not DungeonBattleScene_ then DungeonBattleScene_ = require("ui.dungeon.DungeonBattleScene") end
